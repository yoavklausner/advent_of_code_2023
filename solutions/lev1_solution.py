...
def dig_first_or_last(input_line, is_first: bool):
    ...
    while not finish_line(line_iter, input_line, is_first):
...
def print_lev1_solution():
    with open("solutions/lev1_input.txt", 'r') as input_file:
        total_sum = 0
